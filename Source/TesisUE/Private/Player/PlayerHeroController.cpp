...
void APlayerHeroController::SetupInputComponent()
{
    ...
    if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
    {
        if (InputData->Inputs.MoveAction)
        {
            ...
            EnhancedInputComponent->BindAction(InputData->Inputs.MoveAction, ETriggerEvent::Completed, this, &APlayerHeroController::Input_Move);
        }
        ...
        {
            EnhancedInputComponent->BindAction(InputData->Inputs.CrouchAction, ETriggerEvent::Started, this, &APlayerHeroController::AbilityInputTagPressed, EVelmaraAbilityInputID::Dodge);
            EnhancedInputComponent->BindAction(InputData->Inputs.CrouchAction, ETriggerEvent::Completed, this, &APlayerHeroController::AbilityInputTagReleased, EVelmaraAbilityInputID::Dodge);
        }
        ...
        {
            EnhancedInputComponent->BindAction(InputData->Inputs.InventoryAction, ETriggerEvent::Started, this, &APlayerHeroController::AbilityInputTagPressed, EVelmaraAbilityInputID::Interact);
            EnhancedInputComponent->BindAction(InputData->Inputs.InventoryAction, ETriggerEvent::Completed, this, &APlayerHeroController::AbilityInputTagReleased, EVelmaraAbilityInputID::Interact);
        }

        if (InputData->Inputs.ToggleWeaponAction)
        {
            EnhancedInputComponent->BindAction(InputData->Inputs.ToggleWeaponAction, ETriggerEvent::Started, this, &APlayerHeroController::AbilityInputTagPressed, EVelmaraAbilityInputID::Interact);
            EnhancedInputComponent->BindAction(InputData->Inputs.ToggleWeaponAction, ETriggerEvent::Completed, this, &APlayerHeroController::AbilityInputTagReleased, EVelmaraAbilityInputID::Interact);
        }
        
        if (InputData->Inputs.AttackAction)
        {
            EnhancedInputComponent->BindAction(InputData->Inputs.AttackAction, ETriggerEvent::Started, this, &APlayerHeroController::AbilityInputTagPressed, EVelmaraAbilityInputID::Attack);
            EnhancedInputComponent->BindAction(InputData->Inputs.AttackAction, ETriggerEvent::Completed, this, &APlayerHeroController::AbilityInputTagReleased, EVelmaraAbilityInputID::Attack);
        }
