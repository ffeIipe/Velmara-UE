...
void ASpectre::GetHit_Implementation(const FVector& ImpactPoint, TSubclassOf<UDamageType> DamageType, const float DamageReceived)
{
	Super::GetHit_Implementation(ImpactPoint, DamageType, DamageReceived);
}
